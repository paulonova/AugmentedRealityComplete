...
public class InfocarTwoModelsAttSameTrack extends ARViewActivity {
...
//			final File mManModel = AssetsManager.getAssetPathAsFile(getApplicationContext(), "InfocarModelsAttSameTime/Assets/TestBild/md2_animation_test.md2");
			final File mManModel = AssetsManager.getAssetPathAsFile(getApplicationContext(), "InfocarTwoModelsAttSameTrack/Assets/TestBild/rotating_engine_01.md2");
...
//					mMan.setCoordinateSystemID(1);
					...
					mMan.startAnimation("rotate", true);
					mMan.setAnimationSpeed(90f); 
			...
			final File mEngineModel = AssetsManager.getAssetPathAsFile(getApplicationContext(), "InfocarTwoModelsAttSameTrack/Assets/TestBild/static_engine.md2");			
			if(mEngineModel!= null){
				mEngine = metaioSDK.createGeometry(mEngineModel);
				if(mEngine != null){
					mEngine.setScale(0.05f);
//					mEngine.setCoordinateSystemID(1);					
